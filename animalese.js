...
// modified to be synchonous by Jeff Hykin 
import letterLibrary from "./animalese.wav.binaryified.js"
 ...
 * ```
 * @param {string} script - The words you want the character to say.
 * @param {boolean} shorten - A boolean indicating whether to shorten the animalese output.
      ...
      if (c >= 'A' && c <= 'Z') {
        ...
        for (var i = 0; i < output_samples_per_letter; i++) {
          data[c_index * output_samples_per_letter + i] =
              letterLibrary[44 + library_letter_start + Math.floor(i * pitch)];
        }
 ...
 * @param {boolean} [options.shorten=false] - A boolean indicating whether to shorten the animalese output.
